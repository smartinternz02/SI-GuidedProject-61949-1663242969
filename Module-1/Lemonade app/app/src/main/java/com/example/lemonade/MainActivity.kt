    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                tai = R.string.lemon_select
                // TODO: Additionally, for each state, the lemonImage should be set to the corresponding
                //  drawable from the drawable resources. The drawables have the same names as the strings
                //  but remember that they are drawables, not strings.
                sir = R.drawable.lemon_tree
            }
            SQUEEZE -> {
                tai = R.string.lemon_squeeze
                sir = R.drawable.lemon_squeeze
            }

            DRINK -> {
                tai = R.string.lemon_drink
                sir = R.drawable.lemon_drink
            }

            RESTART -> {
                tai = R.string.lemon_empty_glass
                sir = R.drawable.lemon_restart
            }
        ...
        textAction.setText((tai))
        lemonImage!!.setImageResource(sir)
    }
